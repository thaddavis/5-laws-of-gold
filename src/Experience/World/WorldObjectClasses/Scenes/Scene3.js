...
export default class Scene3 {
  constructor() {
    ...
    this.text = new MetalText({
      instanceName: INSTANCE_NAMES.THREE,
      text: "3.",
    ...
    this.part1OfLaw3 = new MetalText({
      instanceName: INSTANCE_NAMES.PART_1_OF_LAW_3,
      text: "Gold stays close to those",
      position: new THREE.Vector3(0, 2, 2),
      scale: new THREE.Vector3(1, 1, 1),
    });

    this.group.add(this.part1OfLaw3.mesh);

    this.part3OfLaw3 = new MetalText({
      instanceName: INSTANCE_NAMES.PART_2_OF_LAW_3,
      text: "who invest it cautiously",
      position: new THREE.Vector3(0, 0, 2),
      scale: new THREE.Vector3(1, 1, 1),
    });

    this.group.add(this.part3OfLaw3.mesh);

    this.part3OfLaw3 = new MetalText({
      instanceName: INSTANCE_NAMES.PART_3_OF_LAW_3,
      text: "and with the guidance of the wise.",
      position: new THREE.Vector3(0, -2, 2),
      scale: new THREE.Vector3(1, 1, 1),
    });
