...
export default class Scene5 {
  constructor() {
    ...
    this.text = new MetalText({
      instanceName: INSTANCE_NAMES.FIVE,
      text: "5.",
    ...
    this.part1OfLaw4 = new MetalText({
      instanceName: INSTANCE_NAMES.PART_1_OF_LAW_5,
    ...
    this.part3OfLaw4 = new MetalText({
      instanceName: INSTANCE_NAMES.PART_2_OF_LAW_5,
      text: "who chase high-risk/high-reward",
    ...
    this.part3OfLaw4 = new MetalText({
      instanceName: INSTANCE_NAMES.PART_3_OF_LAW_5,
      text: "investments.",
      position: new THREE.Vector3(0, -2, 2),
      scale: new THREE.Vector3(1, 1, 1),
    });
